...
export const scoringPartner = {
  ...
  science: {
    ...
    src: "/product/scoring-science-ta.png?v=20260915",
  ...
  maths: {
    ...
    src: "/product/scoring-maths.png?v=20260915",
...
export const productShots = {
  dashboard: {
    ...
    alt: "LearnLi dashboard in teacher mode for Grade 12, with subject cards for Mathematics, Physics, Chemistry and Biology.",
    width: 1918,
    height: 868,
  },
  askLi: {
