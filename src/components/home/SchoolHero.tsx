...
export function SchoolHero() {
  return (
    <section data-pdf-chunk className="pdf-block relative mx-auto max-w-7xl overflow-hidden px-5 pt-10 pb-8 sm:px-8 sm:pt-14">
        ...
        <div className="li-hero-grid grid items-start gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-12">
          ...
          <div className="li-hero-shot-wrap overflow-hidden rounded-[2rem] bg-[#d7eef6] shadow-[0_22px_50px_-28px_rgba(27,63,71,0.45)] ring-1 ring-foreground/8">
            <Image
              ...
              priority
              unoptimized
              className="pdf-hero-shot h-auto w-full"
            />
          </div>
        </div>

      <div className="mt-6">
        <div className="li-eco-strip grid gap-4 rounded-[1.6rem] bg-foreground px-5 py-5 text-cream sm:grid-cols-[1.4fr_repeat(3,0.8fr)] sm:items-center sm:px-7">
          <div>
